...
void test_fim_db_insert_data_no_rowid_error(void **state) {
    ...
    expect_string(__wrap__mterror, formatted_msg, "Step error inserting data row_id '0': ERROR MESSAGE (111)");
...
void test_fim_db_insert_data_rowid_error(void **state) {
    ...
    will_return(__wrap_sqlite3_extended_errcode, 111);
    expect_string(__wrap__mterror, tag, SYSCHECK_MODULE_TAG);
    expect_string(__wrap__mterror, formatted_msg, "Step error updating data row_id '1': ERROR MESSAGE (111)");
    int ret;
    int row_id = 1;
...
void test_fim_db_insert_path_error(void **state) {
    ...
    expect_string(__wrap__mterror, tag, SYSCHECK_MODULE_TAG);
    expect_string(__wrap__mterror, formatted_msg, "Step error replacing path '/test/path': ERROR MESSAGE (111)");
...
void test_fim_db_insert_fail_to_remove_existing_entry(void **state) {
    ...
    expect_string(__wrap__mterror, tag, SYSCHECK_MODULE_TAG);
    expect_string(__wrap__mterror, formatted_msg, "Step error deleting data: ERROR MESSAGE (111)");
...
void test_fim_db_insert_inode_id_null_error(void **state) {
    ...
    will_return(__wrap_sqlite3_extended_errcode, 111);
    expect_string(__wrap__mterror, tag, SYSCHECK_MODULE_TAG);
    expect_string(__wrap__mterror, formatted_msg, "Step error getting data row: ERROR MESSAGE (111)");
...
void test_fim_db_get_count_file_data_error(void **state) {
    ...
    will_return(__wrap_sqlite3_extended_errcode, 111);
    expect_string(__wrap__mterror, tag, SYSCHECK_MODULE_TAG);
    expect_string(__wrap__mterror, formatted_msg, "Step error getting count entry data: ERROR MESSAGE (111)");
...
void test_fim_db_get_count_file_entry_error(void **state) {
    ...
    will_return(__wrap_sqlite3_extended_errcode, 111);
    expect_string(__wrap__mterror, tag, SYSCHECK_MODULE_TAG);
    expect_string(__wrap__mterror, formatted_msg, "Step error getting count entry path: ERROR MESSAGE (111)");
...
void test_fim_db_set_scanned_error(void **state) {
    ...
    will_return(__wrap_sqlite3_extended_errcode, 111);
    expect_string(__wrap__mterror, tag, SYSCHECK_MODULE_TAG);
    expect_string(__wrap__mterror, formatted_msg, "Step error setting scanned path '/test/path': ERROR MESSAGE (111)");
